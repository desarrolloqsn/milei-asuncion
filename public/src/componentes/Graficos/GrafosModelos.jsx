...
export default function GrafosModelos(){
 ...
 <Select placeholder="Fechas" className='fechas-grafos' onChange={handleFiltroFechaChange} defaultValue={filtroFecha}>
  ...
  <a href={`https://qsngrafos.vercel.app/modelos/milei-asuncion/grafo_modelo-Atributos-${filtroFecha}.html`} target="_blank">
  <div className=' cartaGrafo-modelos'>
  ...
  <a href={`https://qsngrafos.vercel.app/modelos/milei-asuncion/grafo_modelo-Clima%20social-${filtroFecha}.html`} target="_blank">
  <div className=' cartaGrafo-modelos'>
