...
Esta combinación de grafos, proporciona una visión más profunda y precisa de la estructura, y el significado de la información contenida en el texto analizado.
    ...
    <a href={`https://qsngrafos.vercel.app/palabras/milei-asuncion/grafo_palabras-frecuentes-${filtroFecha}.html`} target="_blank"><Button  shape="circle">
    ...
    <div className='bigramas-trigramas'>
      ...
      <Tooltip title='Abrir en otro navegador'>
    <a href={`https://qsngrafos.vercel.app/palabras/milei-asuncion/grafo_bigramas-frecuentes-${filtroFecha}.html`} target="_blank"><Button className='boton-abrirnavegador' shape="circle">
        <MdOpenInNew/>
    </Button>
     </a>
    </Tooltip>
      ...
      <Tooltip title='Abrir en otro navegador'>
    <a href={`https://qsngrafos.vercel.app/palabras/milei-asuncion/grafo_trigramas-frecuentes-${filtroFecha}.html`} target="_blank"><Button className='boton-abrirnavegador' shape="circle">
        <MdOpenInNew/>
    </Button>
     </a>
    </Tooltip>
